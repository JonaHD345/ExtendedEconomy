        ...
        if (args.length == 1) {
            if (args[0].equalsIgnoreCase("help")) {
                if (sender.hasPermission("extendedeconomy.admin")) {
                    ...
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "§acommands§8:");
                    ...
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + this.plugin.getConfigService().getMessages().get("messages.line"));
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "§acommands§8:");
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "  §8• §7/§aextendedeconomy §7<§ahelp§7>");
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "  §8• §7/§amoney");
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "  §8• §7/§apay §7<§aPlayer§7> <§aAmount§7>");
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "  §8• §7/§abalancetop");
                    sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + this.plugin.getConfigService().getMessages().get("messages.line"));
                }
                ...
                sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "§7made by §2JonaHD345 §8(§2https://jonahd345.de§8)");
                sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "§7for more §7/§aextendedeconomy help");
                sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + this.plugin.getConfigService().getMessages().get("messages.line"));
            }
        } else {
            sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + this.plugin.getConfigService().getMessages().get("messages.line"));
            sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") +
                    "§a§lExtendedEconomy §7v§a" + this.plugin.getDescription().getVersion().replace(".", "§7.§a"));
            sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "§7made by §2JonaHD345 §8(§2https://jonahd345.de§8)");
            sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "§7download §8(§2https://www.spigotmc.org/resources/extendedeconomy.106888/§8)");
            sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + "§7for more §7/§aextendedeconomy help");
            sender.sendMessage(this.plugin.getConfigService().getMessages().get("messages.prefix") + this.plugin.getConfigService().getMessages().get("messages.line"));
        }
        return false;
